...
By the LRT, we add the interaction term to the model.  
...
mod.pois_pqi05 <- glm(pqi05 ~ expansion_status + percent_male + 
    ...
    percent_eligible_for_medicaid_2 + expansion_status * percent_eligible_for_medicaid + 
